...
def print_banner(bot: triggerBot) -> None:
    ...
    print("===== Kontroller =====")
    print("Aktifleştirme Tuşu / Activation key  :", Fore.YELLOW + TRIGGER_KEY + Style.RESET_ALL)
    print("Mod Değiştirme Tuşu / Mode Switching Key :", Fore.YELLOW + SWITCH_KEY + Style.RESET_ALL)
    print("Yakalama Alanı Ayar / Setting Capture Area
  :", Fore.YELLOW + GRABZONE_KEY_UP + "/" + GRABZONE_KEY_DOWN + Style.RESET_ALL)
    print("==== Information
 ===")
    print("Mod / mode                 :", Fore.CYAN + mods[bot.mode] + Style.RESET_ALL)
    print("Yakalama Alanı / Capture area      :", Fore.CYAN + str(GRABZONE) + "x" + str(GRABZONE) + Style.RESET_ALL)
    print("Trigger Durumu / Trigger Status
      :", (Fore.GREEN if bot.toggled else Fore.RED) + ("Açık" if bot.toggled else "Kapalı") + Style.RESET_ALL)
    print("Bunny Durumu / Bunny Status        :", (Fore.GREEN if bot._bunny else Fore.RED) + ("Açık" if bot._bunny else "Kapalı") + Style.RESET_ALL)
    print("Son Reaksiyon Süresi / Final Reaction Time
 :", Fore.CYAN + str(bot.last_reac) + Style.RESET_ALL + " ms ("+str((bot.last_reac)/(GRABZONE*GRABZONE))+"ms/pix)")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
